/**
 * Advanced Design Editor Plugin - Complete Design Editing Configuration for CE.SDK
 *
 * This plugin extends the base design editor configuration with advanced features
 * for Creator mode template design.
 *
 * @example Basic usage
 * ```typescript
 * import CreativeEditorSDK from '@cesdk/cesdk-js';
 * import { AdvancedDesignEditorConfig } from './plugin';
 *
...
/**
 * Advanced Design Editor configuration plugin.
 *
 * Provides a complete design editing experience with advanced features,
 * optimized for creating graphics, templates, marketing materials,
 * and multi-page documents.
 *
 * @public
 */
export class AdvancedDesignEditorConfig implements EditorPlugin {
  /**
   * Unique identifier for this plugin.
   * Used to identify the plugin in the CE.SDK plugin registry.
   */
  name = 'cesdk-advanced-design-editor';
  ...
  /**
   * Initialize the advanced design editor configuration.
   *
